...
cd dist
rm -f "$OUT"
zip -qr "$OUT" manifest.json background.js content.js webauthn-inject.js base64.js popup.js popup.css martian-mono-latin.woff2 ibm-plex-sans-latin.woff2 icons src
